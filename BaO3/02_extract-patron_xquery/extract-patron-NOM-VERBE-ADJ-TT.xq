(: extraction du patron NOM-VER-ADJ :)
...
(: est-ce que cat(E1) = NOM ET cat(E2) = VER ET cat(E3) = ADJ :)
...
where (($element/data[1]="NOM") and (contains($frere/data[1], "VER")) and ($next_frere/data[1]="ADJ"))

(: extraction du patron VER-DET-NOM :)
...
(: est-ce que cat(E1) = VER ET cat(E2) = DET ET cat(E3) = NOM :)
...
where ((contains($element/data[1], "VER")) and (contains($frere/data[1], "DET")) and ($next_frere/data[1]="NOM"))
